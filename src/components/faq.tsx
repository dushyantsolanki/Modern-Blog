...
const faqs = [
  ...
  },
  {
    ...
    answer: "Yes! Our weekly digest, 'Xenon Weekly,' summarizes the top stories and includes exclusive resources, curated links, and early access to our 12,000+ subscribers."
  },
  {
          ...
          <div className="lg:w-1/3">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground leading-relaxed mb-8">
                Everything you need to know about Xenon. If you can't find the answer you're looking for, feel free to reach out.
              </p>
              <Button
                variant="outline"
