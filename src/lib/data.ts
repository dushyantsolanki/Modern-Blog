...
export const posts: Post[] = [
  {
    ...
    summaryPoints: [
      "AI is shifting from a tool for creation to a collaborative partner in the design process.",
      "The role of the designer is evolving into that of a 'Curator' and 'Director'.",
      "Staying competitive requires mastering the art of 'Prompt Engineering' and 'AI Orchestration'.",
      "Human emotional intelligence and contextual understanding remain unique, irreplaceable assets."
    ]
  },
  {
