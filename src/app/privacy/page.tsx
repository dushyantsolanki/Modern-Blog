                ...
                <div className="flex items-start gap-8">
                  ...
                  <div>
                    ...
                    <div className="space-y-6 text-muted-foreground font-medium leading-[1.8]">
                      <p>Welcome to Xenon ("we," "our," or "us"). We are committed to protecting your personal information and your right to privacy. If you have any questions or concerns about our policy or our practices with regards to your personal information, please contact us.</p>
