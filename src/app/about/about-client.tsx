          ...
          <section className="py-24 border-y border-border/50">
            <div className="container mx-auto px-6">
              <div className="max-w-4xl mx-auto">
                ...
                >
                  <p>
                    InFixe was built on a simple observation: the internet is full of
                ...
                <div className="lg:w-2/3 grid grid-cols-1 md:grid-cols-2 gap-12">
                  {team.map((member: any, i: number) => (
                    <motion.div
                      ...
                      className="group"
                    >
                      <div className={cn("aspect-square rounded-[3rem] mb-8 transition-transform group-hover:scale-[0.98] duration-700 bg-cover bg-center", member.accent)} style={member.avatar ? { backgroundImage: `url(${member.avatar})` } : {}} />
