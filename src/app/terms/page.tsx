              ...
              <motion.div {...FADE_UP} id="property">
                <div className="flex items-start gap-8">
                  ...
                  <div>
                    ...
                    <div className="space-y-6 text-muted-foreground font-medium leading-[1.8]">
                      <p>Unless otherwise indicated, the website and its original content, features, and functionality are owned by InFixe and are protected by international copyright, trademark, and patents.</p>
                      <p>Our trademarks and trade dress may not be used in connection with any product or service without the prior written consent of InFixe.</p>
                    </div>
                  </div>
                </div>
              </motion.div>
